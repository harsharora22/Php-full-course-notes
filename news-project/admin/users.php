...
$offset = ($page - 1) * $limit;
$Ssql = "SELECT * FROM user LIMIT {$offset},{$limit}";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        ?>
            ...
            echo "Admin";
              ...
              <td class='edit'><a href="update-user.php?id=<?php echo $row['user_id'] ?>"><i class='fa fa-edit'></i></a>
              </td>
...
if (mysqli_num_rows($result1) > 0) {
    ...
    if ($page > 1) {
        echo "<li><a href='users.php?page=" . ($page - 1) . "'> &#8592 </a></li>";
    }
    ...
    if ($totalPages > $page) {
        echo "<li><a href='users.php?page=" . ($page + 1) . "'>  &#8594 </a></li>";
    }
    echo "</ul>";
}
?>
